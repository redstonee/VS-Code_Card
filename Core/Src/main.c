...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /**/
  LL_GPIO_ResetOutputPin(LED18_GPIO_Port, LED18_Pin);

  /**/
  LL_GPIO_ResetOutputPin(LED17_GPIO_Port, LED17_Pin);
  ...
  /**/
  LL_GPIO_ResetOutputPin(LED14_GPIO_Port, LED14_Pin);

  /**/
  LL_GPIO_ResetOutputPin(LED15_GPIO_Port, LED15_Pin);

  /**/
  LL_GPIO_ResetOutputPin(LED16_GPIO_Port, LED16_Pin);

  /**/
  LL_GPIO_ResetOutputPin(LED12_GPIO_Port, LED12_Pin);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(LED14_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(LED15_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(LED16_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(LED12_GPIO_Port, &GPIO_InitStruct);
